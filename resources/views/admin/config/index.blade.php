                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="timepicker1" data-target-input="nearest">
                        <input type="text" name="in_begin" value="{{old('in_begin', $config ? $config->in_begin : '')}}"
                          class="form-control datetimepicker-input" data-target="#timepicker1"
                          placeholder="Absensi berangkat" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="timepicker2" data-target-input="nearest">
                        <input type="text" name="in_over" value="{{old('in_over', $config ? $config->in_over : '')}}"
                          class="form-control datetimepicker-input" data-target="#timepicker2"
                          placeholder="Absensi berangkat berakhir" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="timepicker3" data-target-input="nearest">
                        <input type="text" name="out_begin"
                          value="{{old('out_begin', $config ? $config->out_begin : '')}}"
                          class="form-control datetimepicker-input" data-target="#timepicker3"
                          placeholder="Absensi berangkat berakhir" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="timepicker4" data-target-input="nearest">
                        <input type="text" name="out_over" value="{{old('out_over', $config ? $config->out_over : '')}}"
                          class="form-control datetimepicker-input" data-target="#timepicker4"
                          placeholder="Absensi berangkat berakhir" required>
