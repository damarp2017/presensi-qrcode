...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Siswa Baru</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Tambah Siswa Baru</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Form Tambah Siswa Baru</h3>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nisn" name="nisn"
                                        placeholder="Masukan NISN Siswa" required autofocus value="{{ old('nisn') }}"
                                        maxlength="10">
                                </div>
                                <div class="form-group">
                                    <label for="name">Nama Siswa</label>
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Masukan Nama Siswa" required value="{{ old('name') }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone"
                                        placeholder="Masukan Kontak Siswa" required value="{{ old('phone') }}">
                                </div>
                                <div class="form-group">
                                    <label for="address">Alamat Siswa</label>
                                    <textarea class="form-control" rows="3" id="address" name="address" required
                                        placeholder="Masukan Alamat Siswa">{{ old('address') }}</textarea>
                                </div>
                            </div>
